...
class DistributionLayoutTest(unittest.TestCase):
    ...
    def test_readme_installs_canonical_skill_for_ide(self) -> None:
        ...
        self.assertIn("Full multi-session orchestration", readme)
        self.assertIn("In Codex CLI, enter `/plugins`", readme)
        ...
        self.assertIn("builds the project knowledge index", readme)
        self.assertIn("installation output in real time", readme)
        ...
        self.assertIn("A bare invocation without a clear objective", readme)
