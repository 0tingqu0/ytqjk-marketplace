...
class RagCliTest(unittest.TestCase):
    def test_lexical_index_excludes_secrets_and_returns_citations(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            stale = run_rag(knowledge, "query", repo, "多会话总控")
    ...
    def test_local_remote_path_is_replaced_by_fingerprint(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            git(
                ...
                "add",
                "origin",
                "file:///C:/Users/Alice/private/repo.git",
            )
    ...
    def test_query_layers_only_approved_global_knowledge(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(found["results"][0]["scope"], "global")
            self.assertEqual(
            ...
            stale = run_rag(knowledge, "query", repo, "复审通过")
            self.assertTrue(stale["global_stale"])
            ...
            self.assertEqual(safe_mention["results"][0]["scope"], "global")
